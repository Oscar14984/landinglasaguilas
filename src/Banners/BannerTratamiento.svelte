...
<main>
    <div id="cardCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="d-flex flex-row">
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Diseño de Sonrisa</h5>
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">El blanqueamiento dental es un procedimiento que aclara los dientes que están manchados, decolorados o que se han oscurecido por un golpe. Se puede realizar en dientes vitales o en dientes con endodoncia.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <div class="d-flex flex-row">
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Implantología</h5>
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Prótesis Bucales</h5>
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Las carillas son unas capas delgadas de porcelana hechas a la medida que cubren la parte del enfrente de los dientes y se utilizan para cerrar espacios, dientes manchados, con mala formación o ligeramente chuecos. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Los terceros molares, comúnmente llamados “muelas del juicio”, pueden permanecer en boca siempre y cuando se encuentren correctamente posicionadas, pero desgraciadamente, esto no sucede en la mayoría de los casos.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex flex-row">
                    ...
                    <div class="card col-md-4" on:click={()=>pushTratamientos()}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">La Periodoncia trata la salud de las encías que son tan importantes como las piezas dentales. Un cuidado deficiente de las encías puede derivar en patologías como el sarro, causando inflamación y provocando este sangrado.</p>
                        </div>
                    </div>
            ...
            <!-- Continúa repitiendo este patrón para las siguientes slides -->
        </div>
